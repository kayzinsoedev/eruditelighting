...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		$data['entry_max_letter'] = $this->language->get('entry_max_letter');
		...
		if (isset($this->request->post['date_special_start'])) {
			$data['date_special_start'] = $this->request->post['date_special_start'];
		} elseif (!empty($product_info)) {
			$data['date_special_start'] = ($product_info['date_special_start'] != '0000-00-00') ? $product_info['date_special_start'] : '';
		} else {
			$data['date_special_start'] = date('Y-m-d');
		}
		
		if (isset($this->request->post['date_special_end'])) {
			$data['date_special_end'] = $this->request->post['date_special_end'];
		} elseif (!empty($product_info)) {
			$data['date_special_end'] = ($product_info['date_special_end'] != '0000-00-00') ? $product_info['date_special_end'] : '';
		} else {
			$data['date_special_end'] = date('Y-m-d');
		}
		...
		foreach ($product_options as $product_option) {
			...
			$data['product_options'][] = array(
				...
				'price_type'           => isset($product_option['price_type']) ? $product_option['price_type'] : 0,
				'price'                => isset($product_option['price']) ? $product_option['price'] : 0.00,
				'max_letter'           => isset($product_option['max_letter']) ? $product_option['max_letter'] :0,
		...
		foreach ($data['product_options'] as $product_option) {
			if ($product_option['type'] == 'select' || $product_option['type'] == 'radio' || $product_option['type'] == 'checkbox' || $product_option['type'] == 'image' || $product_option['type'] == 'number') {
