          ...
          <tbody>
            ...
            <tr>
              <td class="text-left"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a>
                ...
                &nbsp;<small> - <?php echo $option['name']; ?>: <?php echo nl2br($option['value']); ?></small>
                <?php } else { ?>
                &nbsp;<small> - <?php echo $option['name']; ?>: <a href="<?php echo $option['href']; ?>"><?php echo nl2br($option['value']); ?></a></small>
                <?php } ?>
                <?php } ?></td>
                <?php if($user_group == 2){ ?>
                      <td class="text-left"><?php echo $product['model']; ?></td>
                <?php } ?>
              <td class="text-left"><?php echo $product['sku_detail']; ?></td> 
