        ...
        <form action="<?= $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab-general">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-checkout-note"><?= "Checkout Note"; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_checkout_note" rows="5" placeholder="<?= "Checkout Note"; ?>" id="input-checkout-note" class="form-control"><?= $config_checkout_note; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-important-note"><?= "Sunday Important Note"; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_important_note" rows="5" placeholder="<?= "Important Note"; ?>" id="input-important-note" class="form-control"><?= $config_important_note; ?></textarea>
                </div>
              </div>
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-postal-code-note"><?= "Disable Postal Code Message"; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_postal_code_note" rows="5" placeholder="<?= "Disable Postal Code Message"; ?>" id="input-postal-code-note" class="form-control"><?= $config_postal_code_note; ?></textarea>
                </div>
              </div>
            ...
            <div class="tab-pane" id="tab-store">
              ...
              <div class="form-group <?=$is_dev?>">
                <label class="col-sm-2 control-label" for="input-geocode"><?= "Google Map Script"; ?></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-whatsapp-telephone"><?= "Whatsapp Telephone"; ?></label>
                <div class="col-sm-10">
                  <input type="text" name="config_whatsapp_telephone" value="<?= $config_whatsapp_telephone; ?>" placeholder="<?= "Whatsapp Telephone"; ?>" id="input-whatsapp-telephone" class="form-control" />
                </div>
              </div>
              <div class="form-group">
              ...
              <div class="form-group <?=$is_dev?>">
                <label class="col-sm-2 control-label" for="input-direction"><span data-toggle="tooltip" data-container="#tab-general" title="<?= $help_direction; ?>"><?= $entry_direction; ?></span></label>
                <div class="col-sm-10">
                  <textarea name="config_direction" rows="5" placeholder="<?= $entry_direction; ?>" id="input-direction" class="form-control"><?= $config_direction; ?></textarea>
                </div>
              </div>
              <?php if ($locations) { ?>
              <div class="form-group">
            ...
            <div class="tab-pane" id="tab-option">
              <fieldset>
                ...
                <div class="form-group required">
                  <label class="col-sm-2 control-label" for="input-length-message"><span data-toggle="tooltip" title="<?= $help_length_message; ?>"><?= $entry_length_message; ?></span></label>
                  <div class="col-sm-10">
                    <input type="text" name="config_length_message" value="<?= $config_length_message; ?>" placeholder="<?= $entry_length_message; ?>" id="input-admin-limit" class="form-control" />
                    <?php if ($error_length_message) { ?>
                    <div class="text-danger"><?= $error_length_message; ?></div>
                    <?php } ?>
                  </div>
                </div>
                <div class="form-group required">
