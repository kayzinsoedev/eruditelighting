...
<?php foreach ($fields as $field) { ?>
  ...
  <?php } elseif ($field == 'zone') { ?>
	...
	<div class="col-sm-6<?php echo !empty(${'field_' . $field}['required']) ? ' required' : ''; ?> ">
	  ...
	  <select name="zone_id" class="form-control hide" id="input-shipping-zone"></select>
	</div>
  ...
  <?php } else { ?>
	...
	<div<?php echo $field == 'postcode' ? ' id="shipping-postcode-required"' : ''; ?> class=" col-sm-6<?php echo !empty(${'field_' . $field}['required']) ? ' required' : ''; ?>">
	  ...
	  <input type="text" name="<?php echo $field; ?>" placeholder="<?php echo !empty(${'field_' . $field}['placeholder']) ? ${'field_' . $field}['placeholder'] : ''; ?>" value="<?php echo ${$field} ? ${$field} : ${'field_' . $field}['default']; ?>" class="form-control  <?= ($field=='telephone' || $field=='postcode')?'input-number':''; ?>"  id="input-shipping-<?php echo str_replace('_', '-', $field); ?>" />
	</div>
	<?php } else { ?>
...
<script type=text/javascript">
	...
	$('#input-shipping-postcode').trigger('keyup');
</script>