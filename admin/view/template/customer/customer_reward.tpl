    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="text-center">
          <button data-loading-text="<?php echo $text_loading; ?>" data-reward="<?php echo $reward['reward_id']; ?>" data-toggle="tooltip" title="<?php echo $button_reward_remove; ?>" class="btn btn-danger btn-xs button-reward-remove"><i class="fa fa-minus-circle"></i></button>
        </td>
      </tr>
      <?php } ?>
      <tr>
...
<script type="text/javascript">
  ...
  $('.button-reward-remove').on('click', function(e) {
    ...
    if (confirm('<?php echo $text_alert; ?>')) {
      ...
      $.ajax({
        url: 'index.php?route=sale/order/removereward&token=<?php echo $token; ?>&reward_id=' + reward_id,
        beforeSend: function() {
