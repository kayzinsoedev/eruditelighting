...
class ControllerReportCustomerOrder extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/customer_order/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function export() {
		...
		$results = $this->model_report_customer->getOrders($filter_customerorder);
