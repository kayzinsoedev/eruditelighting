				...
				<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-menu" class="form-horizontal">
					...
					<div class="tab-content">
						...
						<div class="tab-pane " id="tab-data">
							...
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-custom">Enquiry</label>
								<div class="col-sm-10">
                                                                    <select name="custom" id="input-custom" class="form-control">
                                                                        <option value="1" <?php if($custom == 1){echo "SELECTED";}?>><?= $text_yes; ?></option>
                                                                        <option value="0" <?php if($custom == 0){echo "SELECTED";}?>><?= $text_no; ?></option>
                                                                    </select>
								</div>
							</div>
							<div class="form-group">
								<label class="col-sm-2 control-label" for="input-vote"><?php echo $entry_vote; ?></label>
								<div class="col-sm-10">
                                                                    <select name="vote" id="input-vote" class="form-control">
                                                                        <option value="1" <?php if($vote == 1){echo "SELECTED";}?>><?= $text_yes; ?></option>
                                                                        <option value="0" <?php if($vote == 0){echo "SELECTED";}?>><?= $text_no; ?></option>
                                                                    </select>
								</div>
							</div>
							 <div class="form-group">
								<label class="col-sm-2 control-label" for="input-month_special"><?php echo $entry_month_special; ?></label>
								<div class="col-sm-10">
                                                                    <select name="month_special" id="input-month_special" class="form-control">
                                                                        <option value="1" <?php if($month_special == 1){echo "SELECTED";}?>><?= $text_yes; ?></option>
                                                                        <option value="0" <?php if($month_special == 0){echo "SELECTED";}?>><?= $text_no; ?></option>
                                                                    </select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<select name="status" id="input-status" class="form-control">
										...
										<?php } ?>
                                                        ...
                                                        <div class="form-group">
								<label class="col-sm-2 control-label" for="input-delivery-start-day"><?php echo $entry_delivery_day; ?></label>
								<div class="col-sm-10">
									<input type="text" name="delivery_day" value="<?php echo $delivery_day; ?>" placeholder="<?php echo $entry_delivery_day; ?>" id="input-delivery-start-day" class="form-control" />
								</div>
							</div>
                                                        <div class="form-group">
								<label class="col-sm-2 control-label" for="input-selfpick-start-day"><?php echo $entry_selfpick_day; ?></label>
								<div class="col-sm-10">
									<input type="text" name="selfpick_day" value="<?php echo $selfpick_day; ?>" placeholder="<?php echo $entry_selfpick_day; ?>" id="input-selfpick-start-day" class="form-control" />
								</div>
							</div>
						</div>
