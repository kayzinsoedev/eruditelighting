          ...
          <table id="images" class="table table-striped table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr id="image-row<?php echo $image_row; ?>">
                ...
                <!-- <td class="text-left" style="width: 30%;min-width:80px;"><input type="textarea" rows="4" name="gallimage_image[<?php echo $image_row; ?>][description]" value="<?php echo $gallimage_image['description']; ?>" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td> -->
...
function addImage() {
	...
	// html += '  <td class="text-left" style="width: 30%;min-width:80px;"><input type="text" name="gallimage_image[' + image_row + '][description]" value="" placeholder="<?php echo $entry_description; ?>" class="form-control" /></td>';
