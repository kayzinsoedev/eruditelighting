...
class ControllerQuickCheckoutGuestShipping extends Controller {
  	public function index() {
		...
		if (isset($this->session->data['shipping_address']['address_1'])) {
		  ...
		  //  if($this->session->data['shipping_address']['postcode'] != "198740"){
			 //   $data['address_1'] = $this->session->data['shipping_address']['address_1'];
		  //  }else{
		  //      $data['address_1'] = '';
		  //  }
	...
	public function validate() {
		...
		if (!$json) {
			...
			if (!empty($telephone['required'])) {
			    if ((utf8_strlen($this->request->post['telephone']) < 8) || (utf8_strlen($this->request->post['telephone']) > 8)) {
			...
			if (!empty($unit_no['required'])) {
				if ((utf8_strlen($this->request->post['unit_no']) < 1) || (utf8_strlen($this->request->post['unit_no']) > 128)) {
			...
			if ($country_info && $country_info['postcode_required'] && (utf8_strlen($this->request->post['postcode']) < 6) || (utf8_strlen($this->request->post['postcode']) > 6)) {
