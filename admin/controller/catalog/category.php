<?php
	class ControllerCatalogCategory extends Controller {
		...
		protected function getForm() {
			...
			$data['entry_month_special'] = $this->language->get('entry_month_special');
			$data['entry_delivery_day'] = $this->language->get('entry_delivery_day');
			$data['entry_selfpick_day'] = $this->language->get('entry_selfpick_day');
			...
			if (isset($this->request->post['month_special'])) {
				$data['month_special'] = $this->request->post['month_special'];
			}
			elseif (!empty($category_info)) {
				$data['month_special'] = $category_info['month_special'];
			}
			else {
				$data['month_special'] = 0;
			}
			...
			elseif (!empty($category_info)) {
				$data['delivery_day'] = $category_info['delivery_day'];
			}
			else {
				$data['delivery_day'] = 0;
			}
                        
			if (isset($this->request->post['selfpick_day'])) {
				$data['selfpick_day'] = $this->request->post['selfpick_day'];
			}
			elseif (!empty($category_info)) {
				$data['selfpick_day'] = $category_info['selfpick_day'];
			}
			else {
				$data['selfpick_day'] = 0;
			}
