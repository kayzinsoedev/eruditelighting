...
class ModelToolProEmail extends Model {
  ...
  public function __construct($registry) {
	...
	***************************/
    ...
    if (!empty($params['mail'])) {
      ...
      if (isset($params['enquiry_attacment'])){
        $params['mail']->addAttachment($params['enquiry_attacment']);
      }
  ...
  private function getDefaultInvoice($order_info) {
    ...
    $data['columns'] = array('image', 'product', 'price');
  ...
  private function getDefaultInvoiceEnquiry($order_info) {
    ...
    $data['columns'] = array('image', 'product', 'quantity');
