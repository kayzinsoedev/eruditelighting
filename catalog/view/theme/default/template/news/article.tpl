<div class="article-content">
    <div class="col-sm-12">
        <div class="media-detail__btn-group btn-group">
            <!--<a class="media-detail__btn pointer" href="<?= $back; ?>"><img class="link_arrow_left" src="image/cssbackground/arrow-left.png">Back</a>-->
            <a class="media-detail__btn pointer" onclick="window.history.go(-1)">
                <!-- <img class="link_arrow_left" src="image/cssbackground/arrow-left.png"> -->Back</a>
            <?php if($prev_news){ ?>
        ...
        <?php if ($category) { ?>
            <div class="category"><h4><?php echo $category; ?></h4></div>
        <?php } ?>
    </div>
    <div class="col-md-6 col-sm-12">
        <?php if ($heading_title) { ?>
            <div class="name"><h3><?php echo $heading_title; ?></h3></div>
        <?php } ?>
	<div class="article-meta">
                <?php echo date("d F Y",strtotime($date_added)); ?>
<!--		<div class="article-share">
    ...
    <div class="col-md-6 col-sm-12">
	<?php if ($popup) { ?>
		<a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" class="colorbox"><img style="padding: 15px; " align="left" src="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image-article" /></a>
	<?php } ?>
    </div>
    <div class="col-sm-12">
