...
<div class="row tnc_page">
    <h3 style="text-align:center;"><?php echo $tnc_title; ?></h3>
    <?php echo $tnc_description; ?>
    <div style="text-align:center;margin-top:50px;">
        <button class="btn btn-danger agree_tnc">Yes, I Agree</button>
        <button class="btn btn-danger" onclick="window.location.href='<?php echo $back; ?>'">Cancel</button>
    </div>   
</div>
<script>
    $('.confirm_page').hide();
