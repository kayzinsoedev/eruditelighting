...
class ControllerQuickCheckoutCheckout extends Controller {
	...
	public function index() {
		...
		$this->document->addScript('catalog/view/javascript/jquery/quickcheckout/quickcheckout.js');
                $this->document->addScript('catalog/view/javascript/jquery/datepicker/datepicker.min.js');
                $this->document->addStyle('catalog/view/javascript/jquery/datepicker/datepicker3.css');
        ...
        $data['postal_message'] =  $this->config->get('config_postal_code_note');
