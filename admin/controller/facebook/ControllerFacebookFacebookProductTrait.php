...
trait ControllerFacebookFacebookProductTrait {
  ...
  private function loadFacebookModel($model_name) {
    ...
    if (!$is_facebook_model_loaded) {
      $admin = 'admin';
      if(defined('ADMIN_FOLDER')) $admin = ADMIN_FOLDER;
  ...
  public function validateFAEAndCatalogSetup(
    ...
    $facebook_setting[FacebookCommonUtils::FACEBOOK_FEED_ID] = '224905937678951';
     //debug($facebook_setting[FacebookCommonUtils::FACEBOOK_FEED_ID]);
    //debug(FacebookCommonUtils::FACEBOOK_FEED_ID);
...
//    debug($facebook_setting[FacebookCommonUtils::FACEBOOK_UPLOAD_ID]);
    
    $facebook_setting[FacebookCommonUtils::FACEBOOK_UPLOAD_ID] = '123';
    
 //   debug(FacebookCommonUtils::FACEBOOK_UPLOAD_ID);
