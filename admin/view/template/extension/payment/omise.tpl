        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          <div class="panel panel-default">
            ...
            <div class="panel-body">
              ...
              <!-- Account Display Omise status -->
              <div class="form-group">
                <label class="col-sm-2 control-label" for="omise_account_display_status"><?php echo $label_account_display_omise_status; ?></label>
                <div class="col-sm-10">
                  <select name="omise_account_display_status" class="form-control">
                    <option value="1" <?php echo $omise_account_display_status ? 'selected="selected"' : ''; ?>><?php echo $text_enabled; ?></option>
                    <option value="0" <?php echo !$omise_account_display_status ? 'selected="selected"' : ''; ?>><?php echo $text_disabled; ?></option>
                  </select>
                </div>
              </div> <!-- /END Account Display Omise status (.form-group) -->
