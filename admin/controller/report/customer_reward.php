...
class ControllerReportCustomerReward extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/customer_reward/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	public function export() {
		...
		$results = $this->model_report_customer->getRewardPoints($filter_customerreward);
