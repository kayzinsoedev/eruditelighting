...
class ControllerExtensionPaymentOmise extends Controller {
    ...
    private function pageDataSettingTab() {
        ...
        return array(
            ...
            'omise_account_display_status'        => $this->config->get('omise_account_display_status'),
    ...
    private function pageTranslation() {
        ...
        return array(
            ...
            'label_account_display_omise_status'      => $this->language->get('label_account_display_omise_status'),
