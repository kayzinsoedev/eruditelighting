...
class ControllerReportSaleReturn extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/sale_return/export', 'token=' . $this->session->data['token'] . $url, true);
   ...
   'limit'                  =>   $limit
	   ...
	   $results = $this->model_report_return->getReturns($filter_salereturn);
