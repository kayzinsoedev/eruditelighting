...
class ControllerReportSaleTax extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/sale_tax/export', 'token=' . $this->session->data['token'] . $url, true);
	...
	$filter_group = 'week';
	$filter_order_status_id = 0;
	$page = 1;		$this->load->model('report/sale');
...
$filter_saletax = array(
	...
	'limit'                  => $limit
		...
		$results = $this->model_report_sale->getTaxes($filter_saletax);
