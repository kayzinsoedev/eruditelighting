<div class="table-responsive">
    <?php if($different == 1){ ?>
            <!--<p class="note_text">Please take note that your selected item requires a longer lead time</p>-->
    <?php } ?>
		...
		<tbody>
					...
					<tr>
						<td class="image"><?php if ($product['thumb']) { ?>
							...
							<?php } ?></td>
						<td class="name"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?><br/> [<?= $button_view; ?>]</a><br>
    						<?php if($different == 1 && $product['day'] > 3){
                                echo "<span style='color:red;font-size:12px;'>This item requires a minimum lead time of ".$product['day']." days</span>";
                            } ?>
							<div>
...
<p style="margin-top:20px;"><?php echo "<b>Note:</b> ".html_entity_decode($checkout_note); ?></p>