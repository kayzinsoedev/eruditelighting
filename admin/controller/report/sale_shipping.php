...
class ControllerReportSaleShipping extends Controller {
	public function index() {
		...
		$data['export'] = $this->url->link('report/sale_shipping/export', 'token=' . $this->session->data['token'] . $url, true);
...
$filter_saleshipping = array(
	...
	'limit'                  =>   $limit
		...
		$results = $this->model_report_sale->getShipping($filter_saleshipping);
