  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <!--<button data-toggle="tooltip" title="<?php echo "Export Order"; ?>" onclick = "window.open('<?= $export; ?>')" class="btn btn-warning"><i class="fa fa-download"></i></button>-->
        <button type="submit" id="button-export" form="form-order" formaction="<?= $export; ?>" formtarget="_blank" data-toggle="tooltip" title="Export Order" class="btn btn-warning"><i class="fa fa-download"></i></button>
      ...
      <div class="panel-body">
        <div class="well">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="form-group">
                <label class="control-label" for="input-delivery_date"><?php echo "Delivery Date"; ?></label>
                <div class="input-group date">
                  <input type="text" name="filter_delivery_date" value="<?php echo $filter_delivery_date; ?>" placeholder="<?php echo "Delivery Date"; ?>" data-date-format="YYYY-MM-DD" id="input-delivery_date" class="form-control" />
              ...
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'o.delivery_date') { ?>
                    <a href="<?php echo $sort_delivery_date; ?>" class="<?php echo strtolower($order); ?>"><?php echo "Delivery Date"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_delivery_date; ?>"><?php echo "Delivery Date"; ?></a>
                    <?php } ?></td>
                  <td class="text-left"><?php if ($sort == 'o.delivery_time') { ?>
                    <a href="<?php echo $sort_delivery_time; ?>" class="<?php echo strtolower($order); ?>"><?php echo "Delivery Time"; ?></a>
                    <?php } else { ?>
                    <a href="<?php echo $sort_delivery_time; ?>"><?php echo "Delivery Time"; ?></a>
                    <?php } ?></td>    
...
function setBtnActive(){
  $('#button-pickpacklist, #button-shipping, #button-invoice, #button-export').prop('disabled', true);

	var selected = $('input[name^=\'selected\']:checked');

	for (i = 0; i < selected.length; i++) {
		if ($(selected[i]).parent().find('input[name^=\'shipping_code\']').val()) {
			$('#button-pickpacklist, #button-shipping, #button-invoice, #button-export').prop('disabled', false);
...
// IE and Edge fix!
$('#button-pickpacklist, #button-shipping, #button-invoice, #button-export').on('click', function(e) {
