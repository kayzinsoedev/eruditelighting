    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-option" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-size"><?php echo "Printing Type"; ?></label>
            <div class="col-sm-10">
                <select name="size" id="input-size" class="form-control">
						<option value="0" <?php if($size == 0){echo "SELECTED";}?>>Normal</option>
						<option value="1" <?php if($size == 1){echo "SELECTED";}?>>Size</option>
						<option value="2" <?php if($size == 2){echo "SELECTED";}?>>Flavour</option>
			    </select>
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-export"><?php echo "Export Excel"; ?></label>
            <div class="col-sm-10">
                <select name="export" id="input-export" class="form-control">
						<option value="1" <?php if($export == 1){echo "SELECTED";}?>>Yes</option>
						<option value="0" <?php if($export == 0){echo "SELECTED";}?>>No</option>
			    </select>
            </div>
          </div>
          <!--<div class="form-group">
            <label class="col-sm-2 control-label" for="input-size"><?php echo "Display in Excel Option"; ?></label>
            <div class="col-sm-10">
                <select name="size" id="input-size" class="form-control">
						<option value="1" <?php if($size == 1){echo "SELECTED";}?>>Bracket</option>
						<option value="0" <?php if($size == 0){echo "SELECTED";}?>>Title</option>
			    </select>
            </div>
          </div>-->
