  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        ...
        <button type="submit" form="form-total" data-toggle="tooltip" onclick="$('#svsty').val(1);" title="Save & Stay" class="btn btn-primary">Save & Stay</button>
      ...
      <div class="panel-body">
        ...
        <input type="hidden"  name="svsty" id="svsty" />
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <select name="bganycombitotal_status" id="input-status" class="form-control">
                <?php if ($bganycombitotal_status) { ?>
		  ...
		  <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" name="bganycombitotal_sort_order" value="<?php echo $bganycombitotal_sort_order; ?>" placeholder="<?php echo $entry_sort_order; ?>" id="input-sort-order" class="form-control" />
            </div>
          </div>   
        </form>
      </div>
