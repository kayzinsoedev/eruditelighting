...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		$data['entry_length_message'] = $this->language->get('entry_length_message');
		...
		$data['help_length_message'] = $this->language->get('help_length_message');
        ...
        if (isset($this->error['length_message'])) {
			$data['error_length_message'] = $this->error['length_message'];
		} else {
			$data['error_length_message'] = '';
		}
		...
		if (isset($this->request->post['config_checkout_note'])) {
			$data['config_checkout_note'] = $this->request->post['config_checkout_note'];
		} else {
			$data['config_checkout_note'] = $this->config->get('config_checkout_note');
		}
        if (isset($this->request->post['config_important_note'])) {
			$data['config_important_note'] = $this->request->post['config_important_note'];
		} else {
			$data['config_important_note'] = $this->config->get('config_important_note');
		}
		if (isset($this->request->post['config_postal_code_note'])) {
			$data['config_postal_code_note'] = $this->request->post['config_postal_code_note'];
		} else {
			$data['config_postal_code_note'] = $this->config->get('config_postal_code_note');
		}
		...
		if (isset($this->request->post['config_direction'])) {
			$data['config_direction'] = $this->request->post['config_direction'];
		} else {
			$data['config_direction'] = $this->config->get('config_direction');
		}
        ...
        if (isset($this->request->post['config_length_message'])) {
			$data['config_length_message'] = $this->request->post['config_length_message'];
		} else {
			$data['config_length_message'] = $this->config->get('config_length_message');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['config_length_message']) {
			$this->error['length_message'] = $this->language->get('error_limit');
		}
