...
class ControllerCatalogOption extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['export'])) {
			$data['export'] = $this->request->post['export'];
		} elseif (!empty($option_info)) {
			$data['export'] = $option_info['export'];
		} else {
			$data['export'] = '';
		}
	...
	public function autocomplete() {
		...
		if (isset($this->request->get['filter_name'])) {
			...
			foreach ($options as $option) {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'image' || $option['type'] == 'number') {
				...
				if ($option['type'] == 'select' || $option['type'] == 'radio' || $option['type'] == 'checkbox' || $option['type'] == 'number') {
