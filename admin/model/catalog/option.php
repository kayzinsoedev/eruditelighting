...
class ModelCatalogOption extends Model {
	public function addOption($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', sort_order = '" . (int)$data['sort_order'] . "', export = '" . (int)$data['export'] . "', size = '" . (int)$data['size'] . "'");
	...
	public function editOption($option_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "option` SET type = '" . $this->db->escape($data['type']) . "', sort_order = '" . (int)$data['sort_order'] . "', export = '" . (int)$data['export'] . "', size = '" . (int)$data['size'] . "' WHERE option_id = '" . (int)$option_id . "'");
